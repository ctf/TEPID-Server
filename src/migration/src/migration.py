...
class Migration (object):
    def __init__(self, applicable_types: Optional[List[str]], applicable_schema_versions: Optional[List[str]], migration_function: Callable[[str], None], schema_version: str):

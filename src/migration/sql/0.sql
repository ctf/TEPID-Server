...
--
-- Data for Name: adgroup; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.adgroup (_id, _rev, schema, type, name) FROM stdin;
b0d1c325-c2f0-4d15-87b8-e7e447b5c483	\N	\N	group	G1
a9a91ba2-45c4-424e-b61e-cef67b78d96a	\N	\N	group	G2
\.


--
-- Data for Name: course; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.course (_id, _rev, schema, type, name, season, year) FROM stdin;
\.


--
-- Data for Name: destinationticket; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.destinationticket (_id, _rev, schema, type, reason, reported, up, activesince, colorprinting, displayname, email, faculty, givenname, jobexpiration, lastname, longuser, middlename, nick, preferredname, realname, role, salutation, shortuser, studentid) FROM stdin;
\.


--
-- Data for Name: fulldestination; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulldestination (_id, _rev, schema, type, domain, name, password, path, ppm, protocol, up, username, ticket__id) FROM stdin;
\.


--
-- Data for Name: fullsession; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fullsession (_id, _rev, schema, type, expiration, persistent, role, user__id) FROM stdin;
\.


--
-- Data for Name: fulluser; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulluser (_id, _rev, schema, type, activesince, colorprinting, displayname, email, faculty, givenname, jobexpiration, lastname, longuser, middlename, nick, preferredname, realname, role, salutation, shortuser, studentid) FROM stdin;
\.


--
-- Data for Name: fulluser_adgroup; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulluser_adgroup (fulluser__id, groups__id) FROM stdin;
\.


--
-- Data for Name: fulluser_course; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulluser_course (fulluser__id, courses__id) FROM stdin;
\.


--
-- Data for Name: fulluser_courses; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulluser_courses (fulluser__id, name, season, year) FROM stdin;
0000	dbCourseName	2	4444
\.


--
-- Data for Name: fulluser_groups; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.fulluser_groups (fulluser__id, name) FROM stdin;
0000	dbGroups
\.


--
-- Data for Name: marqueedata; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.marqueedata (_id, _rev, schema, type, title) FROM stdin;
3a0b6e33-4242-41ab-9cfa-24c417317b1b	\N	\N	\N	TITLE
\.


--
-- Data for Name: marqueedata_entry; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.marqueedata_entry (marqueedata__id, entry) FROM stdin;
3a0b6e33-4242-41ab-9cfa-24c417317b1b	A
3a0b6e33-4242-41ab-9cfa-24c417317b1b	B
\.


--
-- Data for Name: printjob; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.printjob (_id, _rev, schema, type, colorpages, deletedataon, destination, error, eta, failed, file, isrefunded, name, originalhost, pages, printed, processed, queuename, received, started, useridentification) FROM stdin;
\.


--
-- Data for Name: printqueue; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.printqueue (_id, _rev, schema, type, defaulton, loadbalancer, name) FROM stdin;
fa6d5dd2-d387-4e4f-bcf9-f1c4419dfe48	\N	\N	queue	false	fiddy-fiddy	Queueueueue
\.


--
-- Data for Name: printqueue_destinations; Type: TABLE DATA; Schema: public; Owner: tepid
--

COPY public.printqueue_destinations (printqueue__id, destinations) FROM stdin;
fa6d5dd2-d387-4e4f-bcf9-f1c4419dfe48	A
fa6d5dd2-d387-4e4f-bcf9-f1c4419dfe48	B
\.
